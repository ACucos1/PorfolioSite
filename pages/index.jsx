...
export default function Home() {
  ...
  useEffect(() => {
    ...
    employersTl.current = gsap
      .timeline({
        scrollTrigger: {
          trigger: "#employers",
        },
      })
      .addLabel("employersLoad")
      .from("#employers div", {
        opacity: 0,
        y: 100,
        stagger: 0.2,
    ...
    projectTl.current = gsap
      ...
      .addLabel("projectLoad")
      .from(".projectRightAnimWrap", {
        opacity: 0,
        x: 300,
      })
      .from(
  ...
  return (
    <div className='App'>
      ...
      <footer className='footer'>
        Built from scratch with NextJS by{" "}
        <span className='red'>Alex Cucos</span>
        <br />
        Original design by{" "}
        <span className='revred'>
          <a href='https://github.com/bchiang7' target='blank' rel='noreferrer'>
            Brittany Chiang
          </a>
        </span>
      </footer>
